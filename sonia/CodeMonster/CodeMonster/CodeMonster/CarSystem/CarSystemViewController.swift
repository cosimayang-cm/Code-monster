...
final class CarSystemViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            computerStatusLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 24),
    ...
    private func createFeatureButtons() {
        for feature in car.getInstalledFeatures() {
            let button = UIButton(type: .system)
    ...
    private func updateFeatureButton(feature: Feature, button: UIButton) {
        ...
        button.setTitle(isEnabled ? "✓ \(feature.displayName)" : feature.displayName, for: .normal)
...
extension CarSystemViewController: CarEventObserver {
    func carDidChangeState(_ event: CarEvent) {
        ...
        case .centralComputerTurnedOn, .centralComputerTurnedOff:
            updateComputerUI()
            updateAllFeatureButtons()
