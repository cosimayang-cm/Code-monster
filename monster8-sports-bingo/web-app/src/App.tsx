    ...
    <div className="dashboard-shell">
      <header className="top-header">
        <div className="brand-block">
          <img alt="2xbet" className="brand-wordmark brand-wordmark-header" src="/brand-wordmark.svg" />
        </div>
        ...
        <section className="hero-grid">
          <div className="hero-panel">
            <div className="hero-copy">
              <img alt="2xbet" className="brand-wordmark brand-wordmark-hero" src="/brand-wordmark.svg" />
